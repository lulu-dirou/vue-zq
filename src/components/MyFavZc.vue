    ...
    <el-row :gutter="30">
      <el-col :span="12" v-for="(list,index) in filterLists" :key="list.id">
        <div class="grid-content">
          <div class="favBtn"><i class="iconfont icon-like-heart"></i></div>
          <div class="title-box">
          ...
          <div class="msg-box flex">
            <li><span>{{ list.fwdw}}</span></li>
            <li><span>{{ list.ctsj }}</span> | <span>阅读量：</span><em class="font-warning">{{ list.djl }}</em></li>
          </div>
        </div>
      </el-col>
    </el-row>
